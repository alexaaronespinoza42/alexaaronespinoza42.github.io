    ...
    const fullName = 'Alexandre Espinoza';
    const currenteDate = new Date();
    const currentYear = currenteDate.getFullYear();
    const profilePicture = 'images/mypicture.jpg';
    ...
    let singleFavoriteFood = "Chocolate Ice Cream";
